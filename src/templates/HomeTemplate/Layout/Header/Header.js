import React from 'react'; 
 ...
 function Header(props) {
  ...
  <div className="container flex justify-between h-16 mx-auto">
    <a href="abc" aria-label="Back to homepage" className="flex items-center p-2">
    ...
    <ul className="items-stretch hidden space-x-3 lg:flex">
      <li className="flex">
        <a href="abc" className="flex items-center -mb-0.5 border-b-2 px-4 dark:border-transparent dark:text-violet-400 dark:border-violet-400">Link</a>
      </li>
      <li className="flex">
