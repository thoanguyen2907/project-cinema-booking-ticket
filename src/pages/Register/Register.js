...
import { dangKyAction } from '../../redux/actions/QuanLyNguoiiDungAction/QuanLyNguoiiDungAction';
          ...
          <div className="mt-12">
            <div>
              ...
              <div className="text-sm font-bold text-gray-700 tracking-wide">Phone</div>
                <input name="soDt" onChange={formik.handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"  placeholder="mike@gmail.com" />
              </div>
              <div className="text-sm font-bold text-gray-700 tracking-wide">Name</div>
                <input name="hoTen" onChange={formik.handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"  placeholder="mike@gmail.com" />
              </div>
              </div>
              <div className="mt-8">
            ...
            <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
             <p> Don't have an account ? </p><NavLink to = "/register" className="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign up</NavLink>
        </div>
      </form>
    )
}
